...
var _createComposeMiddleware = require('./middleware/create-compose-middleware');

var _createComposeMiddleware2 = _interopRequireDefault(_createComposeMiddleware);
...
exports.default = function (_ref) {
    ...
    middlewares.forEach(function (item) {
        _createComposeMiddleware2.default.use(item);
    });

    context = new _context2.default(models, {
        middleware: _createComposeMiddleware2.default,
        relation: relation
    });
