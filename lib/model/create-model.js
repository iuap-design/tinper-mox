...
function createModel(_ref) {
    ...
    function MobxModel() {
        ...
        var res = (0, _utils.possibleConstructorReturn)(this, (0, _getPrototypeOf2.default)(MobxModel).call(this, (0, _extends3.default)({}, data, _initData), middleware, (0, _extends3.default)({}, autorun, _autorun), (0, _extends3.default)({}, constants, _constants)));
    ...
    MobxModel.prototype = (0, _assign2.default)(MobxModel.prototype, others, privates, mobxSyncs, mobxAsyncs);
